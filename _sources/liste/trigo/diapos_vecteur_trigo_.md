...
0.35 ![image](./liste/trigo/vect_compo_rep){width="85%"}
...
0.35 ![image](./liste/trigo/trigo_angle.eps){width="85%"}
...
0.35 ![image](./liste/trigo/trigo_arc.eps){width="85%"}

Projection orthogonale

0.65

Projection sur l'axe horizontal La projection orthogonale du point $M$
sur l'axe horizontal vaut $r\cos \theta$.

0.35 ![image](./liste/trigo/trigo_projX.eps){width="85%"}

Projection orthogonale

0.65

Projection sur l'axe vertical La projection orthogonale du point $M$ sur
l'axe vertical vaut $r\sin \theta$.

Rappel : $\cos (\frac{\pi}{2} - \theta) = \sin \theta$

0.35 ![image](./liste/trigo/trigo_projY.eps){width="85%"}
...
0.35 ![image](./liste/trigo/trigo_triangle.eps){width="85%"}
